...
#include<list>
using namespace std;
#define DEBUG_TYPE "demoBasicBlockPass"
 ...
 */
struct DemoBasicBlockPass: public BasicBlockPass {
...
char DemoBasicBlockPass::ID = 1;
static RegisterPass<DemoBasicBlockPass> X("demoBasicBlockPass", "Optimization Pass");
