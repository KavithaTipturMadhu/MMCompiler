...
\section{Additions to current assembly format}
\begin{itemize}
 \item Support for Locales: Arbitrary static locale set instead of just rectangles, dynamic localeset when not indicated. \item Data blocksize if indicated; static data distribution: Affinity of statically divided parts of arrays onto CRs ; dynamic data distribution: Cyclic, BlockCyclic, Block, Random, Recursive Bisection.
 \item Code distribution: CR affinity to segments of code
 \item Support for block based offset for HyperOps
\end{itemize}

\section{JIT requirements}
\begin{itemize}
 \item Support for clDeviceInfo and response format
 \item Support to patch the binary with additional mapping information: Data, Code and HyperOp affinity
 \item Support to compute start addresses for code segments and partitioned data structures and move them to their locales
\end{itemize}
